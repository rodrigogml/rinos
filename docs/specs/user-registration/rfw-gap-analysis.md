...
`bb6328a99a38116d45d4fee417568e8ba911e322`, artefato `br.eng.rodrigogml.rfw:rfw:2.0.0`. A consolidação do Kernel,
...
pluralizado no feedback acessível. Para a continuação externa, o renderer também aplica foco inicial e devolução de
foco ao primeiro aceite obrigatório, preservando o fallback para a ação principal.
