...
- [ ] 3.1.1 Definir DTOs/VOs/enums de solicitação, método, garantia e outcomes públicos
...
- [ ] 3.2.1 Autenticar e-mail normalizado com verificação de hash de custo equivalente para identidades ausentes
...
- [ ] 3.3.1 Criar e publicar `AuthSession` antes de estabelecer contexto local autenticado
...
- [ ] 4.2.1 Adaptar repositories Spring WebAuthn às entities globais sem perda de dados
