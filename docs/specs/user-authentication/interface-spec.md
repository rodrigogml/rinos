...
| `SURF-WEB-RINOS` | `/user` | `src/main/java/br/com/rinos/app/ui/module/user/view/UserDashboardEntryView.java` | Rota protegida do Painel de Usuário, com entrada para Configurações de segurança |
