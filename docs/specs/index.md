...
| 14 | FIN-002 | `financial-categories` | Classificar lançamentos por finalidade financeira e preparar associações contábeis futuras sem incorporá-las à categoria | FND-006, FND-007 | Planejada |
| 15 | FIN-003 | `financial-transactions` | Registrar créditos e débitos imutáveis, categorizados e auditáveis que expliquem o saldo interno das contas | FIN-001, FIN-002, FND-010 | Planejada |
