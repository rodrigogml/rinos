...
| 22 | FIN-010 | `bank-statements-reconciliation` | Importar linhas externas com identidade e origem preservadas, pontuar correspondências explicáveis e conciliá-las de forma idempotente após decisão do usuário | FIN-001, FIN-003, FIN-004, FIN-008, FIN-009, FIN-009A | Planejada |
