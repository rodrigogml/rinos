...
public enum IdentityEventTypeEnum {
  ...
  AUTHENTICATION_REPEATED_FAILURES(false),
  PASSKEY_RISK_DETECTED(false),
  SECURITY_NOTIFICATION_NEW_SESSION(false),
  SECURITY_NOTIFICATION_METHOD_CHANGED(false),
  SECURITY_NOTIFICATION_RECOVERY_COMPLETED(false),
  SECURITY_NOTIFICATION_REPEATED_FAILURES(false),
